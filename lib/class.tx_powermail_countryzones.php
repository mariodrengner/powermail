...
class tx_powermail_countryzones extends tslib_pibase {
	...
	function addZoneSelector($value) {
		...
		if ($this->codeForZoneSelector(0, $value)) {
			$objResponse->addAppend('powermail_countryzoneselect' . $this->uid, 'innerHTML', $this->codeForZoneSelector(0, $value));
		} // add new content // if there are results
